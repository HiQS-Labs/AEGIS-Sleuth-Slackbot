...
3. Use this exact tick binary (run it from any directory): .xyz/bin/tick
   - .xyz/bin/tick claim MARATHON-P3-TURN --agent agy --paths "marathon-system/dev-qa-2026-08-18--p3/RELAY.md,src/chat-module.js,tests/attachment-pipeline-entry-point.test.js"
