...
3. Use this exact tick binary (run it from any directory): /Users/noelsaw/Documents/GH Repos/aegis-sleuth-slack-bot/.xyz/bin/tick
   - /Users/noelsaw/Documents/GH Repos/aegis-sleuth-slack-bot/.xyz/bin/tick claim MARATHON-P2-TURN --agent agy --paths "marathon-system/dev-qa-2026-08-18--p2/RELAY.md,tests/ocr-failure-diagnostics.test.js"
   - /Users/noelsaw/Documents/GH Repos/aegis-sleuth-slack-bot/.xyz/bin/tick ping MARATHON-P2-TURN --agent agy
   - /Users/noelsaw/Documents/GH Repos/aegis-sleuth-slack-bot/.xyz/bin/tick release MARATHON-P2-TURN --agent agy --to codex
...
2. If changes needed: add `**Verdict:** Changes requested`, update the `NEXT:` line to exactly `NEXT: agy (Builder)`, then: /Users/noelsaw/Documents/GH Repos/aegis-sleuth-slack-bot/.xyz/bin/tick release MARATHON-P2-TURN --agent codex --to agy
3. If satisfied: add `**Verdict:** Approved`, set `STATUS: Approved`, then: /Users/noelsaw/Documents/GH Repos/aegis-sleuth-slack-bot/.xyz/bin/tick done MARATHON-P2-TURN --agent codex
