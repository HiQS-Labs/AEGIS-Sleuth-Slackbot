...
# Installs and configures Sleuth app with GitHub Actions runner for automated deployment
...
# Function to create github-runner user
create_runner_user() {
...
# Function to configure GitHub Actions runner
...
display_completion_info() {
    ...
    echo
    log_info "Next steps:"
    echo "1. Configure workspace by creating a JSON file in:"
    ...
    echo
    echo "5. For GitHub Actions deployment to work, make sure your workflow uses:"
