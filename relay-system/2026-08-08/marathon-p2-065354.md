...
3. Use this exact tick binary (run it from any directory): <repo-root>/.xyz/bin/tick
   - <repo-root>/.xyz/bin/tick claim MARATHON-P2-TURN --agent codex --paths "phases/ledger-p3-entity-linking--p2/RELAY.md,src/entity-linking.js,tests/entity-linking.test.js"
   - <repo-root>/.xyz/bin/tick ping MARATHON-P2-TURN --agent codex
   - <repo-root>/.xyz/bin/tick release MARATHON-P2-TURN --agent codex --to agy
...
2. If changes needed: add `**Verdict:** Changes requested` then: <repo-root>/.xyz/bin/tick release MARATHON-P2-TURN --agent agy --to codex
3. If satisfied: add `**Verdict:** Approved`, set `STATUS: Approved`, then: <repo-root>/.xyz/bin/tick done MARATHON-P2-TURN --agent agy
