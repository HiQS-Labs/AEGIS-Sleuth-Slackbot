...
Last recorded reason (<repo-root>/phases/ledger-p3-entity-linking--p6/ESCALATION.md): `pre-advance-failed`. Read it before re-guessing.
...
3. Use this exact tick binary (run it from any directory): <repo-root>/.xyz/bin/tick
   - <repo-root>/.xyz/bin/tick claim MARATHON-P6-TURN --agent codex --paths "phases/ledger-p3-entity-linking--p6/RELAY.md,src/reminders-projection.js,scripts/projection-parity-harness.js,tests/projection-parity.test.js"
