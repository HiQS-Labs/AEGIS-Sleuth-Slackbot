...
- Distinguish a first-person **self-commitment** from first-person **feeling or anticipation**. `I will do X by [time]` and `I'll show the site by end of day tomorrow` are commitments and should be scheduled. `I'm excited/happy to do X by [time]` is emotional commentary and should be ignored. An emotion verb (`excited`, `happy`, `glad`, `looking forward`, `can't wait`) before the action is a strong signal to exclude. A hedge (`probably`, `maybe`, `I think`) on that feeling strengthens `ignore`; it does not by itself exclude a firm commitment such as `I'll probably deploy the hotfix tomorrow`.
...
- First-person statements expressing personal feelings or anticipation about an event rather than a commitment or ask: `I'm excited to...`, `I can't wait to...`, `I'm looking forward to...`, `I'm so happy to...`. These are emotional commentary, not task requests, even if they mention a future time.
